...
default_maxT = datetime(2024, 3, 1)  # Maximum timespan of prediction
...
default_maxT_policies = datetime(2024, 3, 1) # Maximum timespan of prediction under different policy scenarios
